...
namespace Morph.Params
{
  ...
  public class MorphReference : IMorphReference, IDisposable
  {
    ...
    private string fMorphTypeName;
    public string MorphTypeName
    {
      get { return fMorphTypeName; }
    }

    #region IMorphReference Members

    private Servlet fMorphServlet = null;
    public Servlet MorphServlet
    {
      get { return fMorphServlet; }
    }
    ...
    public virtual Apartment MorphApartment
    {
      ...
      set
      {
        if (fMorphServlet != null)
        {
          fMorphApartment.Servlets.Remove(fMorphServlet.ID);
          fMorphServlet = null;
        }
        fMorphApartment = value;
        if (fMorphApartment != null)
          fMorphServlet = fMorphApartment.Servlets.Obtain(this, fMorphTypeName);
      }
    }
